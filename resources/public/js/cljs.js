...
game_of_life.game.compute_char_loc = function(a) {
  ...
  return b ? "#" : cljs.core._EQ_.call(null, a, 3) ? "#" : " "
};
game_of_life.game.get_loc_sum = function(a, b, c) {
  return game_of_life.game.compute_char_loc.call(null, cljs.core.PersistentVector.fromArray([cljs.core.get_in.call(null, c, cljs.core.PersistentVector.fromArray([a, b], !0)), cljs.core.apply.call(null, cljs.core._PLUS_, cljs.core.map.call(null, function(a) {
    return cljs.core._EQ_.call(null, "#", cljs.core.get_in.call(null, c, a)) ? 1 : 0
  }, cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray([a - 1, b - 1], !0), cljs.core.PersistentVector.fromArray([a - 1, b], !0), cljs.core.PersistentVector.fromArray([a - 1, b + 1], !0), cljs.core.PersistentVector.fromArray([a, b - 1], !0), cljs.core.PersistentVector.fromArray([a, b + 1], !0), cljs.core.PersistentVector.fromArray([a + 1, b - 1], !0), cljs.core.PersistentVector.fromArray([a + 1, b], !0), cljs.core.PersistentVector.fromArray([a + 1, b + 1], !0)], !0)))], !0))
};
game_of_life.game.life_step = function(a) {
        ...
        for(;;) {
          if(cljs.core.seq.call(null, e)) {
            ...
            return cljs.core.cons.call(null, cljs.core.apply.call(null, cljs.core.str, function() {
              return function(b) {
                return function i(d) {
                  return new cljs.core.LazySeq(null, false, function(b) {
                    return function() {
                      for(;;) {
                        if(cljs.core.seq.call(null, d)) {
                          var e = cljs.core.first.call(null, d);
                          return cljs.core.cons.call(null, game_of_life.game.get_loc_sum.call(null, b, e, a), i.call(null, cljs.core.rest.call(null, d)))
                        }
                        return null
                      }
                    }
              ...
              }(f).call(null, cljs.core.range.call(null, b))
            }()), d.call(null, cljs.core.rest.call(null, e)))
          }
          return null
        }
      }, null)
                  ...
                  return new cljs.core.LazySeq(null, false, function() {
                    return function() {
                      for(;;) {
                        if(cljs.core.seq.call(null, c)) {
                          cljs.core.first.call(null, c);
                          return cljs.core.cons.call(null, " ", h.call(null, cljs.core.rest.call(null, c)))
                        }
                        return null
                      }
                    }
...
game_of_life.game.set_board_piece = function(a, b, c) {
  var d = cljs.core.nth.call(null, a, b), e = cljs.core.get_in.call(null, a, cljs.core.PersistentVector.fromArray([b, c], !0)), e = cljs.core._EQ_.call(null, e, " ") ? "#" : " ";
  return cljs.core.assoc_in.call(null, a, cljs.core.PersistentVector.fromArray([b], !0), cljs.core.apply.call(null, cljs.core.str, cljs.core.assoc.call(null, cljs.core.into.call(null, cljs.core.PersistentVector.EMPTY, d), c, e)))
};
...
game_of_life.game.fill_rect = function(a, b, c) {
  var a = cljs.core.nth.call(null, a, 0, null), d = cljs.core.nth.call(null, b, 0, null), e = cljs.core.nth.call(null, b, 1, null), f = cljs.core.nth.call(null, b, 2, null), b = cljs.core.nth.call(null, b, 3, null), g = cljs.core.nth.call(null, c, 0, null), h = cljs.core.nth.call(null, c, 1, null), c = cljs.core.nth.call(null, c, 2, null);
  a.fillStyle = [cljs.core.str("rgb("), cljs.core.str(g), cljs.core.str(","), cljs.core.str(h), cljs.core.str(","), cljs.core.str(c), cljs.core.str(")")].join("");
  return a.fillRect(d, e, f, b)
};
...
game_of_life.game.update_itr = function() {
  var a = game_of_life.game.by_id.call(null, "itr-div");
...
game_of_life.game.by_id.call(null, "surface").addEventListener("click", function(a) {
  var b = a.pageX, a = a.pageY, c = game_of_life.game.by_id.call(null, "surface"), d = c.offsetTop, b = cljs.core.int$.call(null, (b - c.offsetLeft) / 10), a = cljs.core.int$.call(null, (a - d) / 10);
  cljs.core.swap_BANG_.call(null, game_of_life.game.game_state, game_of_life.game.set_board_piece, b, a);
  return game_of_life.game.draw_game.call(null)
}, !1);
